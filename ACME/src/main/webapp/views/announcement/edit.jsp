...
<script type="text/javascript">
	function reloadExams() {
		...
		placeholder.load("exam/findByCertificationId.do?certificationId="
				+ certificationId);
	}
</script>
...
<form:form action="announcement/administrator/edit.do"
	...
	<form:select id="certifications" path="certification"
		onchange="javascript: reloadExams()">
		<form:options value="0" label="----" />
	...
	<form:select path="exam" id="exams">
		<form:options value="0" label="----" />
	...
	<form:select path="reviewer" id="reviewers">
		<form:options value="0" label="----" />
	...
	<input type="button" name="cancel"
		...
		onclick="javascript: window.location.replace('announcement/administrator/list.do')" />
	<br />
</form:form>